package com.example.nightblue.moviesforyou.widgets;
...
import com.example.nightblue.moviesforyou.interfaces.onSearchActionsListener;
...
import com.example.nightblue.moviesforyou.utils.Util;
...
public class MaterialSearchView extends FrameLayout implements View.OnClickListener, onSearchActionsListener {
    ...
    public String getSearchQuery() {
        String kkk = mSearchEditText.getText() != null ? mSearchEditText.getText().toString() : "";
        String namegenre = kkk;
        Intent mainIntent = new Intent(mContext, com.example.nightblue.moviesforyou.activity.Menu_selection.class);
